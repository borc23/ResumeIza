            ...
            <div className="space-y-4">
              {profile.email && (
                <a
                  ...
                  className="flex items-center gap-4 p-4 bg-white dark:bg-primary-800/50 rounded-lg shadow hover:shadow-md transition-shadow border border-primary-100 dark:border-primary-700"
                >
