            ...
            {formData.profile_image && (
              <button
                ...
                onClick={() => {
                  ...
                  setMessage({ type: 'success', text: 'Image removed. Click "Save Changes" to update your profile.' });
                }}
            ...
            <>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setMessage({ type: 'success', text: 'CV removed. Click "Save Changes" to update your profile.' });
                }}
                className="px-3 py-1 border border-red-300 dark:border-red-600 rounded-lg text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors text-sm"
              >
                Remove
              </button>
            </>
